...
🤖 Atuo na interseção entre dados, CRM e estratégia comercial transformando operações B2B em processos mais eficientes, escaláveis e orientados por resultados. Tenho background em Engenharia de Software, o que me dá visão técnica para entender sistemas, APIs e automações, uma vantagem na hora de integrar ferramentas, mapear processos e construir soluções que de fato escalam.
